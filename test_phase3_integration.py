...
print("  Credentials come from the environment; none is built in.")
print("  Set NANOBIO_DEMO_ADMIN_PASSWORD (and the SCIENTIST and VIEWER")
print("  equivalents) to enable the legacy Streamlit sign-in page.")
