...
export default function Step1Disease() {
  ...
  /**
   * Guard for the pathway's Save & Continue.
   *
   * Returns false to hold the user here when the selection is incomplete, so
   * Continue cannot advance past a step that has not been answered. The step
   * bookkeeping happens here rather than in the pathway control, which knows
   * about ordering and nothing about this step's science.
   */
  ...
  return (
    <>
      ...
      >
        ...
        {/* Kept alongside the pathway controls: this is the step's own
            "save my work here" action, and it does not navigate. */}
