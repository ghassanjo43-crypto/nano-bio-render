  ...
  return (
    <>
      <Card
        ...
        accent
        actions={
          <div className="np3d__headactions">
            {/* Illustrative geometry never raises readiness. The link makes
                the distinction reachable rather than merely stated. */}
            <Button variant="secondary"
                    onClick={() => navigate('/scientific-readiness')}
                    iconLeft={<Icon name="flask" size={15} />}
                    data-testid="builder-to-readiness">
