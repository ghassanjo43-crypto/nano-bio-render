...
export function WorkflowProvider({ children }: { children: ReactNode }) {
  ...
  const startStudy = useCallback((pathway: StudyPathway,
                                  researchPurpose?: string) => {
    setSession({ ...newSession(), pathway, researchPurpose });
    setResultState(null);
    setPkResultState(null);
    setResultInputsHash(null);
  }, []);
  ...
  const value = useMemo<WorkflowContextValue>(() => ({
    ...
    setSelection, setValue, setChips, setPkValue, setName, reachStep,
    ...
    pkPathway, setPkPathway,
       ...
       setPkValue, setName, reachStep, saveDraft, startNew, startStudy,
