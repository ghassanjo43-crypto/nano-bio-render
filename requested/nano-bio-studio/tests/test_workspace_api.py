...
class TestStoredRuns:
    ...
    def test_another_users_run_is_not_reachable(self):
        """Ownership is checked before existence, so ids cannot be probed."""
...
class TestProjects:
    ...
    def test_assigning_a_run_updates_its_project(self):
        ...
        updated = client.post(
            f"{RUNS_URL}/{run['id']}/project?project_id={project['id']}").json()
