    ...
    def test_adds_missing_columns_to_a_legacy_table(self):
        async def scenario():
            ...
            try:
                ...
                # Only this table's columns. ADDITIVE_COLUMNS also carries
                # entries for other tables, which are absent from this
                # scenario's database and correctly skipped.
                for column in ADDITIVE_COLUMNS:
                    if column.table != "workspace_runs":
                        continue
