...
2. Instructor Notes (in app; set `NANOBIO_INSTRUCTOR_PASSWORD` to enable) - Review teaching resources
...
→ Review Instructor Notes (in app; set `NANOBIO_INSTRUCTOR_PASSWORD` to enable)
